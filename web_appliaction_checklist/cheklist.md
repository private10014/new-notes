...
- **SSO Vulnerabilities**
    - [ ]  If [internal.company.com](http://internal.company.com/) Redirects You To SSO e.g. [auth.company.com](http://auth.company.com/), Do FUZZ
    On [Internal.company.com](http://internal.company.com/)
    - [ ]  If [company.com/internal](http://company.com/internal) Redirects You To SSO e.g. Google login, Try To Insert
    public Before internal e.g. [company.com/public/internal](http://company.com/public/internal) To Gain Access Internal
    ...
    Domain e.g. [http://me.com](http://me.com/) As Value To Steal The Token
